...
export default function TermsOfUseComponent() {
  return (
    ...
    <div className={styles.termsContent}>
      ...
      <span className={styles.myTerms}>Saiba que estou sempre disponível para tirar qualquer dúvida que você tenha pelo <u><a href="mailto:ola@grazielamatanaadvocacia.com.br">grazielamatana@gmail.com</a></u>, pelo canal <u><Link href="/#contact">entre em contato</Link></u> disponível no site e pelo telefone <u><a href="https://api.whatsapp.com/send?phone=54991119962">(54) 99111-9962</a></u>.</span>
      <div className={styles.allTerms}>     
        <h2 className={styles.subtitle}>TERMOS DE USO:</h2>
